...
5.Use this command to verify rtl in synopsys tool
...
****************************************
  ...
  -----------------------------------------
  Resource Sharing:                   10.33
  Logic Optimization:                  9.60
  Mapping Optimization:                4.94
  -----------------------------------------
  Overall Compile Time:               29.14
  Overall Compile Wall Clock Time:    29.98
...
comment these modules in vsdcaravel_synthesis.v

```in vsdcaravel_synthesis.v
/*
